...
* // Initialize a set of asset data on the channel using the chaincode 'InitLedger' function.
			...
			console.log('asset exists check for asset120')
			result = await contract.evaluateTransaction('AssetExists', 'asset120');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			...
			result = await contract.submitTransaction('CreateAsset', 'asset120', 'yellow', '5', 'Tom', '1300');
			console.log('*** Result: committed');
			if (`${result}` !== '') {
				console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			}
			...
			result = await contract.evaluateTransaction('ReadAsset', 'asset120');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);
